  ...
  return (
   <Fade delay={500}>
    ...
    <div class="container px-6 py-12 mx-auto">
        ...
        <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2 bg-gray-50 dark:bg-gray-800">
        <div class="p-4 py-6 rounded-lg  md:p-8">
            <form onSubmit={handleSubmit}>
                <div className="-mx-2 md:items-center md:flex">
                  <div className="flex-1 px-2">
                    <label className="block mb-2 text-sm  font-semibold text-gray-600 dark:text-gray-200">First Name</label>
                    <input
                      type="text"
                      name="name"
                      value={formData.name}
                  ...
                  <div className="">
                  <label className="block mb-2 text-sm font-semibold text-gray-600 dark:text-gray-200">Phone</label>
                  <input
                    type="text"
                    name="phoneNumber"
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-3 font-semibold mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#104E3E] rounded-lg hover:bg-[#4c7a6e] focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50"
                >
                  Send message
                </button>
              </form>
            </div>
            <div class="grid grid-cols-1 gap-12 md:grid-cols-2 md:py-8 px-4 md:px-0">
                <div>
                    ...
                    <Link class="mt-2 text-sm font-bold text-[#FFA72A] " href={`mailto:info@laverde.ae`}>info@laverde.ae</Link>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Our friendly team is here to help.</p>
                    <Link target='_blank' href={`https://api.whatsapp.com/send/?phone=971506144930&text=Hello&type=phone_number&app_absent=0`} class="mt-2 text-sm font-bold text-[#FFA72A]">Start new chat</Link>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm font-bold text-[#FFA72A]"> Office 42, Al Jazeera Towers - Hamdan Bin Mohammed St - Al Danah - Zone 1 - Abu Dhabi</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Mon-Sat from 10:00am to 07:00pm.</p>
